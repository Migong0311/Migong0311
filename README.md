...
일본어 전공을 통해 기른 언어적 감각과 커뮤니케이션 능력을 바탕으로, 현재는 IT 서비스의 논리적 구조를 설계하는 개발자로 성장하고 있습니다. NHN Academy에서 Spring Boot 기반의 MSA 아키텍처를 경험했으며, 현재 SSAFY에서 알고리즘 역량 강화와 더불어 Vue.js와 Django를 연동하는 풀스택 웹 개발 기술을 심화 학습 중입니다.
